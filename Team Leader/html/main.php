				...
				<div class="order">
					<section class="attendance">
						<div class="attendance-list">
						  ...
						  require_once 'db.php';
						  //get all packages
					$sqlpack = "SELECT id,siteid,sitename FROM project_details where userid=$uid ORDER BY id DESC";
					$stmtpack = $conn->prepare($sqlpack);
					$stmtpack->execute();
					$resultpack = $stmtpack->get_result();
					?>
					<table>
						...
						<?php
							...
							<tr>
								...
								<td><?= $sitename; ?></td>
								<td><a  class="button" type="button" href="main copy.php?edit=<?=$id; ?>">View</span></td>
							</tr>
							<?php  } ?>
